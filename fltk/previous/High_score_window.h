...
struct High_score_window : Graph_lib::Window 
{
	/*
	struct Entry 
	{
	...
	*/
    High_score_window(Point xy, int w, int h, const string& title);//vector<Entry> top_scores);
	
	
	//-----here------
	//vector<pair<string,int>> top_scores2;
